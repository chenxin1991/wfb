...
/* @var $searchModel backend\models\WordendSearch */
                    ...
                    [
                        ...
                        'buttons' => [
                            'view' => function ($url, $model, $key) {
                                ...
                                return Html::a('<span class="glyphicon glyphicon-list"></span>', Url::toRoute(['word/view','product_id'=>$model->product_id]), $options ); 
                            },
                        ],    
