...
/* @var $model backend\models\ArticleMixSearch */
...
<div class="row">
    <div class="col-xs-12">
        ...
        {$("#articlemixsearch-product_id").html($data);})']) ?>
        ...
        <?= $form->field($model, 'status')->dropdownList([$model::STATUS_ACTIVE=>'正常', $model::STATUS_COMPLETED=>'已发布到草稿箱'], 
