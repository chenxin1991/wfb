...
/* @var $searchModel backend\models\ArticleMixSearch */
        ...
        <div class="box">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'=>'longtailKeywords',
                        'label' => '长尾关键词',
                        'value'=>function($model){
                            $tmpStr = strip_tags($model->longtailKeywords);//去掉html的标签
...
$this->registerJs(
    '$(".batch-delete").on("click", function () {
        ...
        if(keys==""){
            ...
            if(confirm("确定要删除吗？")){
                $.post("/article-mix/batch-delete", {ids:JSON.stringify(keys)}, function(data){
                    alert(data.msg);
                    location.reload();
                });
            }
