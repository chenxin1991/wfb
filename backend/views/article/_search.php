...
<div class="row">
    <div class="col-xs-12">
        ...
        {$("#articlesearch-product_id").html($data);})']) ?>
        ...
        <?= $form->field($model, 'status')->dropdownList([$model::STATUS_ACTIVE=>'未修改', $model::STATUS_MODIFIED=>'已修改未发布',$model::STATUS_PUBLISHED=>'已发布'], 
        ['prompt'=>'', 'data-placeholder'=>'状态', 'class'=>'form-control select2', 'style'=>'width:150px;']) ?>
